...
class PrescriptionScreen_doc extends StatefulWidget {
  static String id = 'new_prescription';
  const PrescriptionScreen_doc({super.key});

  @override
  State<PrescriptionScreen_doc> createState() => _PrescriptionScreen_docState();
}

class _PrescriptionScreen_docState extends State<PrescriptionScreen_doc> {
