...
class Registrationscreen_pat extends StatefulWidget {
  const Registrationscreen_pat({super.key});

  @override
  State<Registrationscreen_pat> createState() => _Registrationscreen_patState();
}

class _Registrationscreen_patState extends State<Registrationscreen_pat> {
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: kinputdecor.copyWith(
                  hintText: 'physical impairments(if any)',
                ),
              ),
            ),
            SizedBox(
